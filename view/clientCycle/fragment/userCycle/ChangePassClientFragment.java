...
public class ChangePassClientFragment extends Fragment {
    ...
    public ChangePassClientFragment() {
    }
    ...
    public void onViewClicked() {
            moreViewModel.setMyNewPassClient(SharedPreferenceManager.loadClientApiToken(getActivity())
