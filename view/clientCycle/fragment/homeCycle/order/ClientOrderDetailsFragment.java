...
public class ClientOrderDetailsFragment extends Fragment {
    ...
    private void hideViews() {
        if (state.equals("pending")) {
            ...
            rejectBtnFragOrderDetails.setPadding(0, 0, 400, 0);
            rejectBtnFragOrderDetails.setCompoundDrawablePadding(-395);
        }
        if (state.equals("accepted")) {
            callBtnFragOrderDetails.setVisibility(View.GONE);
            rejectBtnFragOrderDetails.setVisibility(View.GONE);
            acceptBtnFragOrderDetails.setText(requireActivity()
                    .getString(R.string.confirm_delivery2));
            acceptBtnFragOrderDetails.setPadding(0, 0, 350, 0);
            acceptBtnFragOrderDetails.setCompoundDrawablePadding(-345);
    ...
    private void setData() {
        ...
        deliveryCostTvFragOrderDetails.setText(getActivity().getString(R.string.delivery_charge, deliveryCost));
    ...
    @OnClick({R.id.accept_btn_frag_order_details, R.id.reject_btn_frag_order_details})
