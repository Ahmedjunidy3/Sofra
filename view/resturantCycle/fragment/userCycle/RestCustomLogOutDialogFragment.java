...
public class RestCustomLogOutDialogFragment extends AppCompatDialogFragment {

    private AlertDialog alertDialog;
    private Unbinder unbinder;

    public RestCustomLogOutDialogFragment() {
    }
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            case R.id.yes_iv_dialog_custom_log_out: {
                SharedPreferenceManager.removeRestEmail(getActivity());
                SharedPreferenceManager.removeRestPassword(getActivity());
