...
public class CustomEditFoodCategDialog extends AppCompatDialogFragment {
    ...
    public CustomEditFoodCategDialog(String title, String btnText, Integer categId) {
        this.title = title;
    ...
    private void setData() {
        titleTvDialogRestFoodCateg.setText(title);
        addBtnDialogRestFoodCateg.setText(btnText);
    }
    ...
    public void onViewClicked(View view) {
        switch (view.getId()) {
            ...
            case R.id.add_btn_dialog_rest_food_categ: {
                restFoodCategViewModel.UpdatedRestFoodCategData(
